  ...
  PopupTemplate, GraphicsLayer
    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            this._singleSym = options.singleSymbol || new sms("circle", 10, null, new Color("#234489"));
            this._singleTemplate = options.singleTemplate || new PopupTemplate({ "title": "", "description": "{*}" });
            this._maxSingles = options.maxSingles || 1000;
            this._webmap = options.hasOwnProperty("webmap") ? options.webmap : false;
            this._sr = options.spatialReference || new SpatialReference({ "wkid": 4490 });
            this._zoomEnd = null;
            this._level = 0;
        },
        ...
        _setMap: function (map, surface) {
            ...
            this._zoomEnd = connect.connect(map, "onZoomEnd", this, function () {
                // update resolution
                this._level = this._map.getLevel();
        ...
        add: function (p) {
            ...
            // add the new data to clusterData so that it's included in clusters
        ...
        setLayer: function (bool, data) {
            if (bool) {
                this.clusterData = this.clusterData.concat(data);
                this.clear();
                this._clusterGraphics();
            }
            else {
                for (var i = 0; i < this.clusterData.length; i++) {
                    if (this.clusterData[i] == data[0]) {
                        this.clusterData.splice(i, data.length);
                        this.clear();
                        this._clusterGraphics();
                        return;
                    }
        ...
        _clusterTest: function (p, cluster) {
            ...
            return (p.attributes.city == cluster.attributes.City);
        },
        ...
        _clusterMeta: function () {
            ...
            console.log("Total:  ", this.clusterData.length);
