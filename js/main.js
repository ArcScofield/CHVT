define([
    ...
    return declare(null, {
        ...
        _createUI: function () {
            ...
            legend = new Legend({
                map: this.map,
                //layerInfos: [{ layer: baseLayer, title: "底图" }],
        ...
        reportError: function (error) {
            ...
            if (node) {
                if (this.config && this.config.i18n) {
                    ...
                    node.innerHTML = "无法创建地图，原因是： " + error.message;
                }
            }
        },
        ...
        _createMapUI: function () {
            ...
            //application/has-config!scalebar? ，如果为false，不做任何处理
